 ...
 *
 * Product
 *Links：https://www.dfrobot.com/wiki/index.php/Gravity:_I2C_SD2405_RTC_Module_SKU:_DFR0469
 *
...
//********************************************************************************************
void GravityRtc::setup() { Wire.begin(); }
...
void GravityRtc::adjustRtc(const __FlashStringHelper *date,
...
//********************************************************************************************
void GravityRtc::adjustRtc(uint16_t year, uint8_t month, uint8_t day,
                           uint8_t week, uint8_t hour, uint8_t minute,
                           uint8_t second) {
  if (year >= 2000)
    year -= 2000;
  WriteTimeOn();
  ...
  Wire.write(
      this->decTobcd(week)); // days values come from 0 to 6: Sunday, Monday,
